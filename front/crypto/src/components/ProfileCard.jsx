        ...
        >
          ...
          >
            ...
            >
              {showUserInfo && (
                <div
                  className="absolute z-[2] flex items-center justify-center backdrop-blur-sm border border-white/10 pointer-events-auto"
                  style={{
                    '--ui-inset': '20px',
                    '--ui-radius-bias': '6px',
                    bottom: 'var(--ui-inset)',
                ...
                >
                  <button
                    className="border border-white/20 rounded-lg px-4 py-3 text-xs font-semibold text-white bg-slate-800/70 hover:bg-slate-700 transition"
